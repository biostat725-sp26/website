...
This assignment is due on **Tuesday, April 7 at 11:45am.** To be considered on time, the following must be done by the due date:
...
-   Go to the [biostat725-sp26](https://www.github.com/biostat725-sp26) organization on GitHub. Click on the repo with the prefix **hw-05**. It contains the starter documents you need to complete the homework.
...
Based on [AE-07](https://biostat725-sp26.netlify.app/ae/ae-07-geospatial), process the `drc` data to create an `sf` data object that can be used for spatial analyses. Create a map that visualizes the proportion of participants with anemia at each community in Sud-Kivu.
