...
```{r, echo=FALSE}
fit_model1 <- readRDS(file = "robjects/linear_regression_ppd_log_lik_fit_model1.rds")
```
...
```{r, echo=FALSE}
fit_model2 <- readRDS(file = "robjects/linear_regression_ppd_log_lik_fit_model2.rds")
```
