...
-   @riutort2023practical used extensive simulations to obtain $m(c,\rho/S)$ for frequently used Matérn covariance functions: Squared exponential, Matérn 5/2, Matérn 3/2 and Matérn 1/2. E.g., for Matérn 3/2,
