...
-   The last few weeks we learned about Gaussian processes.
...
&\propto f(\boldsymbol{\Omega}) f(\boldsymbol{\theta} | \tau^2) \prod_{i=1}^n f({Y}_i | \lambda_i).
\end{align*}
...
-   Work on [HW 05](https://biostat725-sp26.netlify.app/hw/hw-05), which is due April 7.
