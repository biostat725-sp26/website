...
::: incremental
1.  As $\rho$ decreases, the surface is less smooth,
...
::: fragment
Given $\rho$, @riutort2023practical presented formulas for the minimum $c$ and $m$ needed for a near 100% approximation accuracy of the **correlation matrix** for frequently used Matérn covariance functions.
:::
