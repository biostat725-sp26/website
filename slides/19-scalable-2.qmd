...
::: incremental
-   As $\rho$ decreases, the surface is less smooth. $c$ needs to increase to retain boundary accuracy.
...
5.  The iterative algorithm described in @riutort2023practical (i.e., pseudo-codes on slide 12) can be further improved
...
1.  Work on [HW 05](https://biostat725-sp26.netlify.app/hw/hw-05-blank) which will be assigned shortly.
