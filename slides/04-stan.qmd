...
# 
# ## Compile and run model, and save in fit
# fit <- stan(file = 'robjects/straightforward.stan', data = list(Y= Y), 
#             iter = 1000, chains = 4)
# saveRDS(fit, file = "robjects/straightforward_fit.rds")
library(rstan)
fit <- readRDS(file = "robjects/straightforward_fit.rds")
```
...
# saveRDS(fit, file = "robjects/linear_regression_fit.rds")
fit <- readRDS(file = "robjects/linear_regression_fit.rds")
```
