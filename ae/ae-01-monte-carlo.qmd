...
-   Click on the green **CODE** button, select **Use HTTPS** (this might already be selected by default, and if it is, you'll see the text **Clone using the web URL.**). Click on the clipboard icon to copy the repo URL.
...
-   Copy and paste the URL of your assignment repo into the dialog box *Repository URL*. Again, please make sure to have *HTTPS* highlighted under *Clone* when you copy the address.
