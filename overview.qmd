...
[Samuel Berchuck](https://sites.duke.edu/sib2/) is an Assistant Professor in the Department of Biostatistics & Bioinformatics and Statistical Science at Duke University, and a faculty affiliate of Duke AI Health. His work focuses on applications of Bayesian methods in biomedical applications, most prominently for clinical decision support tools using electronic health records.
...
+---------------+--------------+------------------------------+
| Youngsoo Baek | TA           | Tue 1:30 - 3:30pm, Hock 9061 |
+---------------+--------------+------------------------------+
