...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1iQtIr1Uvqp8ZwpbEgHCiQxOM-A0nMbKY021H45zaibc/edit?usp=sharing", sheet = "Sheet1")
```
...
d |>
  ...
  cols_align(
    align = "center", 
    columns = c(week, dow, prepare, slides, ae, hw)
  ) |>
  cols_align(
    align = "left", 
