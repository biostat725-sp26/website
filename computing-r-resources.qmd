...
-   [RStan Getting Started](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started) by Stan Development Team

-   [Brief Introduction to Stan](https://bookdown.org/marklhc/notes_bookdown/brief-introduction-to-stan.html/) by Mark Lai
