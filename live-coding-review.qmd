...
**Note that this is practice Live-Coding and nothing needs to be turned in for this!!!**

This live-coding exercise is to be completed in-class and turned in by **Tuesday, April 7 by 1:00 PM**. To be considered on time, the following must be done by the due date:
...
-   **Date and Time**: Tuesday, April 7, 11:45 AM - 1:00 PM.
...
-   Go to the [biostat725-sp26](https://www.github.com/biostat725-sp26) organization on GitHub. Click on the repo with the prefix **live-coding-review**. It contains the starter documents you need to complete the live-coding exercise.
